                            ...
                            <FlexContainer>
                                <ListItem>
                                    ...
                                    <ListItemText
                                        ...
                                        secondary={
                                            <>
                                                <div>{resources.Price + ": " + element.discount_price + resources.Dollars}</div>
                                                <div>{resources.Count + ": " + (element.count || 0)+ resources.Quantity}</div>
                                                <div>{resources.Avaible + ": " + (element.avaible || element.qty)+ resources.Quantity}</div>
                                            </>
                                        }
                                    />
                                </ListItem>
